...
function LandingPage({
  ...
  <a 
    ...
    className="block relative h-64 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 cursor-pointer group-hover:scale-105 transition overflow-hidden">
    
    {/* Instagram Icon */}
    <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
      <svg className="w-20 h-20 mb-4" fill="white" viewBox="0 0 24 24">
      ...
      <p className="text-xl font-bold mb-2">
        {lang === 'en' ? 'Watch on Instagram' : 'شاهد على إنستغرام'}
      </p>
      <p className="text-sm opacity-90">@amva_eg</p>
